...
import AppImgHeader from './components/AppImgHeader.vue'
import AppMain from './components/AppMain.vue'
import AppMainLink from './components/AppMainLink.vue'
...
<template>
  <AppHeader :linkHeader="linkHeader" />
  <AppImgHeader />
  <AppMain :comics="comics" />
  <AppMainLink :icons="icons" />
  <AppFooter />
  <AppBottomFooter />
</template>
